          ...
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Bebaskan potensi kreatif Anda dengan Temukan, platform yang
                membantu Anda mengeksplorasi dan mengembangkan keterampilan
                artistik Anda.
                <p>
                  Bergabunglah dengan Temukan dan temukan kejeniusan kreatif
                  Anda, karena kami menyediakan platform bagi Anda untuk
                  menemukan dan mengekspresikan bakat unik Anda.
                </p>
              </p>
              <button
              ...
              <button className="btn btn-outline-danger btn-lg rounded-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s">
                Lihat Promo
              </button>
            </Col>
            <Col lang="6" className="pt-lg-0 pt-5">
              <img
                src={HeroImage}
                alt="hero"
        ...
        <Container>
          <Row>
            <Col>
              ...
              <p className="text-center">Lorem8</p>
            </Col>
          </Row>
          <Row>
