...
export const testimonial = [
  {
    id: 1,
    desc: "Saya benar-benar menemukan nilai luar biasa dalam kursus ngoding ini. Materi yang disajikan sangat terstruktur dan mudah dipahami. Sebagai pemula, saya merasa dibimbing dengan baik melalui konsep-konsep dasar hingga ke tingkat yang lebih tinggi. Ini benar-benar meningkatkan kepercayaan diri saya dalam pemrograman.",
    image: People1,
    name: "People 1",
...
export const dataSwiper = [
  {
    id: 1,
    desc: "Saya benar-benar menemukan nilai luar biasa dalam kursus ngoding ini. Materi yang disajikan sangat terstruktur dan mudah dipahami. Sebagai pemula, saya merasa dibimbing dengan baik melalui konsep-konsep dasar hingga ke tingkat yang lebih tinggi.",
    image: People1,
    name: "People 1",
    skill: "UI UX Designer",
  },
  {
    id: 2,
    desc: "Saya telah mencoba beberapa platform belajar ngoding sebelumnya, tetapi baru menemukan yang benar-benar sesuai dengan gaya belajar saya. Materi yang disajikan di sini tidak hanya informatif tetapi juga didukung oleh proyek praktis yang membantu saya mengasimilasi pengetahuan dengan lebih baik.",
    image: People2,
    name: "People 2",
    skill: "Flutter Developer",
  },
  {
    id: 3,
    desc: "Saya sangat terkesan dengan antarmuka pengguna yang ramah pengguna dan interaktif dari platform ini. ",
    image: People3,
    name: "People 3",
    skill: "Web Developer",
  },
  {
    id: 4,
    desc: "Saya mencoba beberapa kursus ngoding sebelumnya, tetapi saya selalu merasa kehilangan arah. Namun, dengan platform ini, saya menemukan fokus yang saya cari. ",
    image: People1,
    name: "People 4",
    skill: "UI UX Designer",
  },
  {
    id: 5,
    desc: "Saya dapat mengakses materi kapan pun saya punya waktu luang, dan pendekatan step-by-step membuatnya mudah diikuti. Sekarang saya merasa siap untuk menghadapi tantangan sebagai seorang pengembang perangkat lunak.",
    image: People2,
    name: "People 5",
    skill: "Flutter Developer",
  },
  {
    id: 6,
    desc: "Pengajar benar-benar berkomitmen untuk membantu dan menjawab pertanyaan saya. Selain itu, komunitas belajar yang dibangun di sekitar platform ini sangat membantu. Saya merasa seperti menjadi bagian dari keluarga besar pemrograman.",
    image: People3,
    name: "People 6",
    skill: "Web Developer",
  },
